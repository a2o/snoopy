 ...
 */
int snoopy_datasource_timestamp_us (char * const resultBuf, size_t resultBufSize, __attribute__((unused)) char const * const arg)
{
    struct timeval tv;
    int            retVal;
    ...
    if (0 == retVal) {
        return snprintf(resultBuf, resultBufSize, "%06d", (int) tv.tv_usec);
    } else {
