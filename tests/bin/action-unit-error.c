...
void snoopyTestCli_action_unit_error_showHelp ()
{
    char * helpContent =
        "Snoopy TEST SUITE CLI utility :: Action `unit` :: Unit `error`\n"
        "\n"
        "Description:\n"
...
int snoopyTestCli_action_unit_error (int argc, char ** argv)
{
    ...
    CFG->output = "stderr";
    snoopy_error_handler("Test error message, sent out via stderr output.");
    ...
    printSuccess("Mocking src/error.c complete.");
    return 0;
}
